...
### Validate with code-architect Agent
Invoke `code-architect` to review slice decomposition for:
...
See `references/checklists.md` for quality checklists, anti-patterns, and agent integration reference.
